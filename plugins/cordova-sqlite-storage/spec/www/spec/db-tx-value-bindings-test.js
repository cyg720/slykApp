  ...
  for (var i=0; i<scenarioCount; ++i) {
    ...
    describe(scenarioList[i] + ': tx stored value bindings test(s)', function() {
      ...
      describe(suiteName + 'transaction column value insertion test(s)', function() {
        ...
        it(suiteName + "INSERT inline BLOB value (X'FFD1FFD2') and check stored entity [Plugin BROKEN: missing result column entity; SELECT BLOB value ISSUE with Android/Windows/WP8]", function(done) {
